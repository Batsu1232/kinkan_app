          ...
          children: [
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemCount: foodListiInfo.length,
                itemBuilder: (context, index) {
                  return ListTile(
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context)=> DetailUI(
                            name: foodListiInfo[index].name!,
                            website: foodListiInfo[index].website!,
                            facebook: foodListiInfo[index].facebook!,
                            mobile: foodListiInfo[index].mobile!,
                            image: foodListiInfo[index].image!,
                            lat: foodListiInfo[index].lat!,
                            lng: foodListiInfo[index].lng!,
                    ...
                    leading: Image.asset(
                      'assets/images/' + foodListiInfo[index].image!,
                    ),
                    title: Text(
                      foodListiInfo[index].name!,
                    ),
                    subtitle: Text(
                      foodListiInfo[index].mobile!,
                    ),
                    trailing: Icon(
